...
public class PatchApiCallUsingPOJOWithLombokTest {
    ...
    @Test
    public void partialUpdateUserTest() throws IOException {
        ...
        // partial update the user object
        requestUser.setName(fullName);
        requestUser.setEmail(emailId);

        // PATCH call - update the user
        apiResponse = requestContext.patch(endPoint + userId, RequestOptions.create()
                .setHeader("Content-Type", "application/json")
                .setHeader("Authorization", "Bearer 89cf87f16f772073ba400974a844aaf551e4086be18a9171e59be21ffa1b662a")
                .setData(requestUser));
