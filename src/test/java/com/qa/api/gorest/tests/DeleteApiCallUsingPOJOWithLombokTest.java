...
public class DeleteApiCallUsingPOJOWithLombokTest {
    ...
    public void deleteUserTest() throws IOException {
        ...
        // DELETE call - delete the user
        apiResponse = requestContext.delete(endPoint + userId, RequestOptions.create()
                .setHeader("Content-Type", "application/json")
                .setHeader("Authorization", "Bearer 89cf87f16f772073ba400974a844aaf551e4086be18a9171e59be21ffa1b662a"));
        ...
        statusText = apiResponse.statusText();
        System.out.println("Status text: " + statusText);
        Assert.assertEquals(statusText, "No Content");
        ...
        statusText = apiResponse.statusText();
        System.out.println("Status text: " + statusText);
        Assert.assertEquals(statusText, "Not Found");
