...
public class DeleteBookingWithTokenTest {
    ...
    public void deleteBooking() {
        ...
        // DELETE call - delete the booking
        apiResponse = requestContext.delete(endPoint + "booking/" + bookingId, RequestOptions.create()
                .setHeader("Content-Type", "application/json")
        ...
        Assert.assertTrue(apiResponse.text().contains("Created"));
